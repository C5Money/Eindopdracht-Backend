...
//    ----------------------------------------------------------------------
    ...
    public ResponseEntity<String> assignUserToWorkSchedules(@PathVariable Long id, @PathVariable String userName){
        String assignedWorkSchedule = workScheduleService.assignUserToWorkSchedules(id, userName);
